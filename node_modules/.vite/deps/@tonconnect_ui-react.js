...
import {
  require_react
} from "./chunk-RNLWXW2W.js";
import {
  require_nacl_fast
} from "./chunk-WMEERAQV.js";
import "./chunk-YYJ3AILK.js";
import {
  __commonJS,
  __toESM,
  require_dist,
  ...
  errorsHandler(eventSource, e2) {
    return __awaiter(this, void 0, void 0, function* () {
      if (this.isConnecting) {
        logError("Bridge error", JSON.stringify(e2));
        return;
      }
      if (this.isReady) {
        try {
